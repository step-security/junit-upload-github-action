...
By default, this action installs the exact `datadog-ci` release pinned by the action version you use. To receive `datadog-ci` updates, update `step-security/junit-upload-github-action` to a newer release or use
